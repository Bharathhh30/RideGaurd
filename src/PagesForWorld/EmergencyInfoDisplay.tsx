...
export default function EmergencyInfoDisplay() {
  ...
  if (loading) return <div className="p-6 text-lg">Loading emergency info...</div>;
  if (!info) return <div className="p-6 text-lg">No information found.</div>;
  console.log("info",info)

  return (
    <div className="max-w-2xl mx-auto p-6">
      <h1 className="text-2xl font-bold mb-4">Emergency Info for {info.fullName}</h1>
      <ul className="space-y-2 text-gray-700">
        ...
        <li><strong>Medical Conditions:</strong> {info.medicalConditions}</li>
